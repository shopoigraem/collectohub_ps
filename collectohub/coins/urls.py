...
urlpatterns = [
    ...
    path('user/cabinet/<int:pk>/coins/', views.UserCabinetCoinsView.as_view(), name='user-cabinet-coins'),
    path('user/cabinet/<int:pk>/my-offers/', views.UserCabinetMyOffersView.as_view(), name='user-cabinet-my-offers'),
    path('user/cabinet/<int:pk>/offers-for-me/', views.UserCabinetOffersForMeView.as_view(), name='user-cabinet-offers-for-me'),
